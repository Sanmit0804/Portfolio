...
const HeaderSocials = () => {
  return (
    <div className="home__socials">
      ...
      <a href="https://github.com/Sanmit0804" className="home__social-link" target="_blank">
        <i className="bx bxl-github"></i>
      </a>

      <a href="discordapp.com/users/748110093672775721" className="home__social-link" target="_blank">
